...
public class PlayerMovement : MonoBehaviour
{
    ...
    public Transform BoundryHolder;
    ...
    void Start()
    {
        ...
        playerBoundry = new Boundry(BoundryHolder.GetChild(0).position.y,
                                     BoundryHolder.GetChild(1).position.y,
                                     BoundryHolder.GetChild(2).position.x,
                                     BoundryHolder.GetChild(3).position.x);
    }
       ...
       if (Input.GetMouseButton(0))
        {
            ...
            if (canMove)
            {
                Vector2 clampedMousePos = new Vector2(Mathf.Clamp(mousePos.x, playerBoundry.Left,
                                                                    playerBoundry.Right),
                                                       Mathf.Clamp(mousePos.y, playerBoundry.Down,
                                                                    playerBoundry.Up));
